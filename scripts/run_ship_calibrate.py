...
SHIP_TYPES = {
    "ULCS": {
        ...
        'Ixx': 1.0e9,                 # Moment of inertia about the x‐axis (roll) (kg·m²)
        ...
        'zG': -5.0,                 # Vertical offset of center of gravity below waterline (m)
        'Xu': -4.5e6,               # Surge force derivative w.r.t. surge velocity (kg/s)
        ...
        'Yv': -1.0e6,             # Sway force derivative w.r.t. sway velocity (kg/s)
        'Yp': 0.0,                  # Sway force derivative w.r.t. roll rate (kg·m)
        'Yr': -5.0e7,                  # Sway force derivative w.r.t. yaw rate (kg·m)
        ...
        'Nv': -2.5e7,                # Yaw moment derivative w.r.t. sway velocity (kg·m²/s)
        'Np': 0.0,                  # Yaw moment derivative w.r.t. roll rate (kg·m²)
        'Nr': -3.0e10,                  # Yaw moment derivative w.r.t. yaw rate (kg·m²)
        'Ydelta': 3.4e7,   # 3.4e7 N of lateral force per radian of rudder
        'Kdelta': 0.0,     # N·m of roll moment per radian (ignored)
        'Ndelta': 2.5e8,   # 6.8e9 N·m of yaw torque per radian of rudder
