"""
Analyze the forced PID trace at scripts/pid_trace_force_short.csv and print summary statistics.
"""
import os, sys
import numpy as np
import csv

CSV = os.path.abspath(os.path.join(os.path.dirname(__file__), 'pid_trace_force_short.csv'))
