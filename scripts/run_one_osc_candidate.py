"""Run the specific oscillation candidate 'keepKp_lowerKd_dtau2.0' once and capture output.
This is a short-run variant (T=120s) to collect early events quickly.
"""
