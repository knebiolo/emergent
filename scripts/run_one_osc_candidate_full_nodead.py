"""Run the specific oscillation candidate 'keepKp_lowerKd_dtau2.0' full-length (T=400s) and capture output, with dead-reck disabled.
"""
...
c = {
    'name': 'keepKp_lowerKd_dtau2.0_full_nodead',
...
sim.spawn()
# disable dead-reck on ship to test controller-only behavior
