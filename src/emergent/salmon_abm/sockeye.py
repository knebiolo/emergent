...
# Backwards-compatible re-export: prefer new simulation module when available
try:
    from .simulation import simulation as simulation  # noqa: F401
except Exception:
    # fallback: the large file defines `simulation` later in this module
    pass
