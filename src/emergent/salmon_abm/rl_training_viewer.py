...
class ControlPanel(QWidget):
    ...
    def init_ui(self):
        ...
        self.cohesion_reward_spin.setValue(0.1)
        ...
        self.alignment_reward_spin.setValue(1.0)
        ...
        self.rheotaxis_penalty_spin.setValue(-100.0)
        ...
        self.separation_penalty_spin.setValue(-0.2)
        ...
        self.fatigue_penalty_spin.setValue(-0.9)
        ...
        self.stagnation_penalty_spin.setValue(-0.9)
        ...
        self.smoothness_penalty_spin.setValue(1.0)
        ...
        self.boundary_penalty_spin.setValue(-10.0)
