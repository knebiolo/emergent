...
class simulation:
    ...
    def load_behavioral_weights(self, weights_path: str = None, weights_dict: dict = None):
        ...
        self.test_weights = {
            ...
            'jump_velocity_ratio_threshold': weights.jump_velocity_ratio_threshold,
            'jump_battery_threshold': weights.jump_battery_threshold,
            'jump_angle_min_deg': weights.jump_angle_min_deg,
            'jump_angle_max_deg': weights.jump_angle_max_deg,
            'order_0': weights.order_0,
            'order_1': weights.order_1,
            'order_2': weights.order_2,
            'order_3': weights.order_3,
            'order_4': weights.order_4,
            'order_5': weights.order_5,
            'order_6': weights.order_6,
            'order_7': weights.order_7,
            'order_8': weights.order_8,
            'order_9': weights.order_9,
        }
