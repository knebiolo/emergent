...
f = h5py.File('outputs/boundary_test2/nuyakuk_headless_headless.h5', 'r')
...
timesteps_to_check = [0, 25, 50, 75, 99] if num_timesteps >= 200 else [0, num_timesteps//2, num_timesteps-1]
